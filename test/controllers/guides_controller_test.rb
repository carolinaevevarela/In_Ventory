...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { editorial_id_id: @guide.editorial_id_id, number_of_guide: @guide.number_of_guide } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { editorial_id_id: @guide.editorial_id_id, number_of_guide: @guide.number_of_guide } }
